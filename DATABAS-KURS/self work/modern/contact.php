...
<body>
  ...
  <div class="container">
    ...
    <!-- Content Row -->
    <div class="row">
      <div class="col-lg-8 mb-4"> <img src="images/LG_Photo_01.jpg" width="200" height="250" ;alt="logo bild">
        <img src="images/RW_Photo_01.jpg" width="180" height="250" ;alt="logo bild"></div>
          ...
          <form name="sentMessage" id="contactForm" novalidate>
            <div class="control-group form-group">
              <div class="controls">
                ...
                <input type="name" class="form-control" name ="name" required data-validation-required-message="Please enter your name.">
