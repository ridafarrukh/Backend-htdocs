            ...
            <body>
             ...
             <header>
                ...
                <div class="container">
                    ...
                    <h1 class="mt-4 mb-3 text-center">Products <br>
                       <small>women clothing</small>
                    </h1>
                    <hr>
                </div>
...
public function viewOneProduct($product)
{
       ...
       <div class="row ">
           <div class="col-md-7">
              <a href="#">
                 <img height="600" width="300" src="$product[product_image]" alt="$product[product_name]" class="img-fluid rounded my-2 mx-5">
              </a>
           </div>
           <div class="col-md-5 py-5">
              <h3>$product[product_name]</h3>
              <p> <b>Price:</b>$product[product_price] kr</p>
              <p> <b>Description:</b>$product[product_description]</p>
              <a class="btn btn-primary" href="#">lägg till
